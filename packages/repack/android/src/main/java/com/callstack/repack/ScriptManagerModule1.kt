...
class ScriptManagerModule1(reactContext: ReactApplicationContext) :
    ...
    init {
        Log.d("ScriptManagerModule", "init ScriptManagerModule1")
    }

    override fun getName(): String {
        Log.d("ScriptManagerModule", "getname ScriptManagerModule1 $NAME")
        return NAME
    }
    ...
    override fun loadScript(scriptId: String, configMap: ReadableMap, promise: Promise) {
        Log.d("ScriptManagerModule", "loadScript() scriptId: $scriptId")
